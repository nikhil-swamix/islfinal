...
import csvData from '../../../../data/department-faculties/CSE.csv';
                                ...
                                <div className="d-flex flex-wrap">
                                    <div className="breadcrumb_media d-flex align-items-center mt-30">
                                        <div className="media_image">
                                            <img className="author" src="https://www.islec.edu.in/docs/cse/csehod.png" alt="author" />
                                        </div>
                                    ...
                                    <div className="breadcrumb_media d-flex align-items-center mt-30">
                                        ...
                                        <div className="media_content media-body">
                                            <h6 className="title mt-2">
                                                <a href="mailto:cse.hod@islec.edu.in">cse.hod@islec.edu.in</a>
                                            </h6>
                                        </div>
                                        <p></p>
                                    </div>
                            ...
                            <section className="dept-tabs mt-20">
                                <Tabs className="dept-tab">
                                    <TabList>
                                        ...
                                        <Tab>Placement</Tab>
                                        <a href="https://islec.edu.in/docs/paqic/cse.pdf">
                                            <Tab>*PAQIC</Tab>
                                        </a>
                                    </TabList>
                                    ...
                                    <TabPanel className="tab-content tab-content-info text-justify ">
                                        <div className="">
                                            ...
                                            <p>
                                                Department of CSE has started its UG program BE(CSE) in the year 2008 with an intake of 60. At present the department has expanded
                                                to 180 students. M. Tech in CSE was started in the year 2021 with an intake of 18. The intellectual ambiance in CSE Department is
                                                conducive to the holistic development of the students with well-equipped labs.
                                            </p>
                                            <p>
                                                CSE department is in process of recognized research under Osmania University. Faculty and students have few patents to their credit.
                                                Department of CSE has center of excellence approved from Osmania University.
                                            </p>
                                            <p>
                                                Department has committed well qualified and professionally active staff and most of the staff are pursuing Ph.D. in emerging areas
                                                like AI, ML, Cyber Security, Data Science, Data Mining, and Block Chain.
                                            </p>
                                            <p>
                                                Department is conducting the workshops and certifications under EduSkills, EC-Council. Various activities are conducted in
                                                collaboration with professional bodies like CSI, ISTE along with student branches of IEEE and CSI.
                                            </p>
                                            <p>
                                                The placement records of the CSE department are exceptional, students getting placed in various MNC. Our placement record has been
                                                consistent with the placement record more of students placed every year. Top companies that visited the campus for placements. The
                                                number of students who are doing internships is gradually increasing every year.
                                            </p>

                                            <h4>ABOUT THE HOD</h4>

                                            <p>
                                                <b>Dr. Mohammed Jameel Hashmi</b> is currently serving as the HOD and Associate Professor in the CSE Department at ISL Engineering
                                                College, affiliated with Osmania University in Hyderabad, Telangana, India. He is a results-driven and dedicated professional with
                                                over 26 years of extensive experience in academia, specializing in Computer Science and Information Technology. He is proficient in
                                                teaching Artificial Intelligence, Machine Learning, and Data Structures at both undergraduate and postgraduate levels. He is
                                                recognized as an External Reviewer for the General Foundation Program by the Oman Accreditation Academic Authority (OAAA). He has
                                                published research papers in various international and national journals. He has also attended various conferences, seminars,
                                                workshops, FDP’s nationally and internationally. He had joined ISL as an Associate Professor in the year 2021, and later on promoted
                                                as HOD of CSE department. He had been ratified in the year 2023.
                                            </p>

                                            <h4>Vision</h4>
                                            <p>
                                                To Establish the department as a centre of learning and innovation in computing and its applications, to produce successful
                                                graduates in computer science & engineering through collaboration between industry and academician to meet the global demand.
                                            </p>
                                            ...
                                            <ul>
                                                <li>
                                                    <i className="fa fa-check"></i>PEO 1 : Gain strong fundamentals concepts and technical competency through innovate solutions to
                                                    solve emerging problems.
                                                </li>
                                                <li>
                                                    <i className="fa fa-check"></i>PEO 2 : Continuously enhance their skills through training in multidisciplinary rapidly changing
                                                    technology.
                                                </li>
                                                <li>
                                    ...
                                    <TabPanel className="tab-content tab-content-info text-justify">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <i className="fa fa-check"></i>PSO 1 : Efficient coding: an ability to analyse a problem, design the algorithm and optimally code
                                                its solution.
                                            </li>
                                            <li>
                                                <i className="fa fa-check"></i>PSO 2 : Software deployment: an ability to identify & define computing requirements to test,
                                    ...
                                    <TabPanel>
                                        <object data="http://islec.edus.in/DATA/CO/cse.pdf" type="application/pdf" width={900} height={900}>
                                            <p>
                                                View Course Outcome here <a href="http://islec.edu.in/DATA/CO/cse.pdf">View PDF!</a>
                                            </p>
                                        </object>
                                    </TabPanel>
                                    <TabPanel>
                                        <div className="syll text-center">
                                            ...
                                            <Table className="striped bordered hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/ACS_LAB_FINAL.pdf">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/CN_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/CO_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/DAA_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/DBMS_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/DISTRIBUTED_SYSTEM_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/DSA_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/DSR_LAB FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/ML_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/OOP_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/OS_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/LAB/SE_LAB_FINAL.pdf">
                                                            <i class="fa fa-download" aria-hidden="true"></i>{' '}
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        <div className="syll text-center">
                                            <Table className="striped bordered hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/CSE-PAPER-PUBLICATION-19-23.pdf">View</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>CSE PAPER PUBLICATION 2017_21</td>
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/CSE-PAPER-PUBLICATION-2017_21.pdf">View</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>CSE PAPER PUBLICATION 2016_20</td>
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/CSE-PAPER-PUBLICATION-2016_20.pdf">View</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>CSE 2018-22 All Publicaton</td>
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/CSE-2018-22-All-Publicaton.pdf">View</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2_Grants_2017_18</td>
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/2_Grants_2017_18.pdf">View</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3_Grants_2016_20</td>
                                                    <td>
                                                        <a href="https://islec.edu.in/docs/cse/publications/3_Grants_2016_20.pdf">View</a>
                                                    </td>
                                                </tr>
                                            </Table>
                              ...
                              <h6 className="card-title">Computer Lab</h6>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club_Activities-Red_Hat.pdf">
                                                        <h6>
                                                            Club Activities-Red Hat <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/FDP-2020-21.pdf">
                                                        <h6>
                                                            FDP-2020-21 <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club-Activities-Cyber-Security.pdf">
                                                        <h6>
                                                            Club Activities-Cyber Security <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club-Activities-Full-Stack.pdf">
                                                        <h6>
                                                            Club Activities-Full Stack <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club-Activities-Python.pdf">
                                                        <h6>
                                                            Club Activities-Python <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>

                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club-Activities-Big-Data-Analytics.pdf">
                                                        <h6>
                                                            Club Activities- Big Data Analytics <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://islec.edu.in/docs/cse/Club-Activities-AWS.pdf">
                                                        <h6>
                                                            Club Activities-AWS <i class="fa fa-external-link" aria-hidden="true"></i>
                                                        </h6>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div className="">
                                            ...
                                            <ul className="mt-30">
                                                <li>
                                                    ...
                                                    <a href="https://islec.edu.in/docs/cse/Resources/EC_Council.pdf"> MoU | EduSkills </a>
                                                </li>
                                                <li>
                                                    <i className="fa fa-angle-double-right"></i>
                                                    <a href="https://islec.edu.in/docs/cse/Resources/EC_Council.pdf"> MoU | EC-Council </a>
                                                </li>
                                                <li>
                                                    <i className="fa fa-angle-double-right"></i>
