            ...
            <section className="dept-tabs mt-30">
                <Tabs className="dept-tab">
                  ...
                  <TabPanel className="tab-content tab-content-info text-justify">
                    ...
                    <p><b>A Training and Placement Cell</b> is a crucial department within educational institutions, particularly colleges and universities that plays a pivotal role in bridging the gap between academia and the professional world. The primary objective of a Training and Placement Cell is to facilitate and support students in their quest for successful careers and to assist organizations in recruiting the right talent.</p>
                    <p>A well-functioning Training and Placement Cell is a win-win for students. Students receive the support they need to embark on a successful career path, while organizations gain access to a pool of talented and well-prepared individuals. It fosters a strong link between academia and industry, contributing to the overall growth and development of students and the organizations they serve.</p>
                    </div>
    ...
    <img className="card-img-top" src="https://islec.edu.in/allimages/placement/ps8.jpg" alt="CardImage " />
        ...
        <p className="card-text">Placed Sudents 2019-2023</p> 
                  ...
                  <TabPanel className="tab-content tab-content-info text-justify">
                    ...
                    <p>The Training and Placements Cell (T&P Cell) at educational institutions, such as colleges and universities, plays a crucial role in bridging the gap between academia and industry. It is responsible for organizing various events and activities to facilitate the placement and skill development of students. </p>
